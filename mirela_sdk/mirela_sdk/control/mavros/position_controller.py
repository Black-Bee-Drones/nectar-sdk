...
HORIZONTAL_INDOOR_KP = 0.1
HORIZONTAL_INDOOR_KI = 0.001
HORIZONTAL_INDOOR_KD = 0.1

VERTICAL_INDOOR_KP = 0.1
VERTICAL_INDOOR_KI = 0.001
VERTICAL_INDOOR_KD = 0.1

HORIZONTAL_INDOOR_MAX_SPEED = 0.3  # m/s
HORIZONTAL_INDOOR_MIN_SPEED = 0.05  # m/s

VERTICAL_INDOOR_MAX_SPEED = 0.2  # m/s
VERTICAL_INDOOR_MIN_SPEED = 0.1  # m/s

# OUTDOOR PID PARAMETERS
HORIZONTAL_OUTDOOR_KP = 0.5
