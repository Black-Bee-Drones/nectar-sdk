...
import cv2
import numpy as np
from mirela_sdk.vision.camera import OakdCam
...
sync_nn = True
oakd = OakdCam()
oakd.create_yolo_detection_network(
    model_path=nnPath, json_path=json_path, sync_nn=sync_nn, confidence=0.4
)
oakd.init_cam()
