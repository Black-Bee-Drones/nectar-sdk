...
- **When you add a module**: update the module README and its parent index; if it is a new top-level area, add **one bullet** under Features in the root README linking to the corresponding page on the [documentation site](https://black-bee-drones.github.io/nectar-sdk/). Follow [Adding a component](#adding-a-component) below.
...
6. **Document**: update the module README.md; for a new top-level module, add one Features bullet in the root README pointing to the site module page
