...
class GatePilot:
    """ArduPilot GUIDED over pymavlink + YOLO + webcam (vision pose fed separately)."""
    ...
    def _read_gate(self):
        ...
        for score, label, box in zip(
            ...
            # Mimic ultralytics box: .xyxy and .conf
            class _Arr:
...
def main() -> None:
    pilot = GatePilot("udp:127.0.0.1:14550")
    try:
