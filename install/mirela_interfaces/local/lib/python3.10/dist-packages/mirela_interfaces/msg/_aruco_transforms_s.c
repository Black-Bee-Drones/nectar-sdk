...
bool mirela_interfaces__msg__aruco_transforms__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mirela_interfaces.msg._aruco_transforms.ArucoTransforms", full_classname_dest, 55) == 0);
  }
  mirela_interfaces__msg__ArucoTransforms * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ArucoTransforms */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mirela_interfaces.msg._aruco_transforms");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArucoTransforms");
