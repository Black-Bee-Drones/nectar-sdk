...
bool mirela_interfaces__msg__line_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mirela_interfaces.msg._line_info.LineInfo", full_classname_dest, 41) == 0);
  }
  mirela_interfaces__msg__LineInfo * ros_message = _ros_message;
  {  // center_x
...
{
  /* NOTE(esteve): Call constructor of LineInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mirela_interfaces.msg._line_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LineInfo");
