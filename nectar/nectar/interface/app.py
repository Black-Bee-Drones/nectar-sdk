...
class NectarApp(QMainWindow):
    """
    Nectar SDK main application window.
    ...
    def _setup_window(self) -> None:
        self.setWindowTitle("Nectar SDK")
    ...
    def _start_ros(self) -> None:
        success = self._ros_executor.start("nectar_gui")
...
def main() -> None:
    """Main entry point for the Nectar SDK GUI application."""
