...
Custom ROS2 message definitions for the Mirela SDK.
...
```python
from mirela_interfaces.msg import PhotoInfo
...
```bash
cd ~/ros2_ws
colcon build --packages-select mirela_interfaces
...
ros2 interface list | grep mirela_interfaces

# Show message definition
ros2 interface show mirela_interfaces/msg/ArucoTransforms
ros2 interface show mirela_interfaces/msg/LineInfo
ros2 interface show mirela_interfaces/msg/PhotoInfo
```
...
```python
# Import messages
from mirela_interfaces.msg import ArucoTransforms, LineInfo, PhotoInfo
...
```cpp
#include "mirela_interfaces/msg/aruco_transforms.hpp"
#include "mirela_interfaces/msg/line_info.hpp"
#include "mirela_interfaces/msg/photo_info.hpp"

auto aruco_pub = node->create_publisher<mirela_interfaces::msg::ArucoTransforms>(
...
- [Vision Module](../mirela_sdk/mirela_sdk/vision/README.md) - Camera drivers and detection algorithms that publish these messages
- [Vision Nodes](../mirela_sdk/mirela_sdk/vision/nodes/) - ROS2 nodes using these interfaces
